const links = [
  ...
  {
    name: 'ORCID',
    href: 'https://orcid.org/0000-0001-8463-6951',
    bg: 'bg-[#A6CE39]',
    svg: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        <path d="M12 0C5.372 0 0 5.372 0 12s5.372 12 12 12 12-5.372 12-12S18.628 0 12 0zm-1.5 5.5c.828 0 1.5.672 1.5 1.5s-.672 1.5-1.5 1.5S9 7.828 9 7s.672-1.5 1.5-1.5zm-1.5 3h3v9h-3v-9zm6 0h3v9h-3v-9z" />
      </svg>
    )
  }
]
